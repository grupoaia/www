...
if (navToggle && navLinks) {
    ...
    navLinks.querySelectorAll('.nav-link, .nav-dropdown-menu a').forEach(link => {
...
document.querySelectorAll('.service-card, .industry-card, .industry-card-link, .tech-item, .pillar, .value-item, .collab-card, .benefit-item, .diff-item, .challenge-card, .ind-solution-card, .case-study, .result-card, .testimonial-card, .use-case-item').forEach(el => {
    el.classList.add('reveal-item');
    revealObserver.observe(el);
});

// Stagger children
document.querySelectorAll('.services-grid, .industries-grid, .tech-grid, .about-pillars, .values-grid, .collab-grid, .benefits-grid, .diff-right, .challenges-grid, .ind-solutions-grid, .results-grid, .testimonials-grid, .use-cases-list').forEach(grid => {
